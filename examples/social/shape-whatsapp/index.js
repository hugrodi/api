...
// Free will settings
const LEVEL_OF_FREE_WILL = 0.3; // Adjust this value (0 to 1)
const DAILY_LEVEL_OF_FREE_WILL = 0.1; // Adjust this value (0 to 1)
const FAVORITE_PEOPLE = ["351968456317@c.us",];
